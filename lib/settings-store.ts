...
interface SettingsStore extends SettingsShape {
  ...
  /** Bulk replace — used by the raw .lucidrc editor when the TOML parses. */
...
/** Strip the store-only methods from the state so we can serialize/compare. */
